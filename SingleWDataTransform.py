...
pathResultFile = "D:\\Daniel\\Documents\\magister\\eksperymenty\\data\\single_w_features.csv"
...
with open(pathResultFile, 'w', newline='') as resultfile:
    ...
    writer.writerow(["FE7XW", "FE7YW", "FE7ZW", "FE8XW", "FE8YW", "FE8ZW", "FE9XW", "FE9YW", "FE9ZW",
                     "FE10XW", "FE10YW", "FE10ZW", "FE11XW", "FE11YW", "FE11ZW", "F12XW", "F12YW", "F12ZW", "Y"])
    ...
    for filename in files:
        ...
        with open(pathDLA + "\\" + filename, 'r') as file:
            ...
            for row in rowp:
                ...
                y = row[1]
                z = row[2]
            writer.writerow([statistics.mean(xw), statistics.mean(yw), statistics.mean(zw),
                             ...
                             max(jerkxw), max(jerkyw), max(jerkzw), "0"])
    resultfile.close();
    ...
    for filename in files:
        ...
        with open(pathFalls + "\\" + filename, 'r') as file:
            ...
            writer.writerow([statistics.mean(xw), statistics.mean(yw), statistics.mean(zw),
                             ...
                             sum(np.absolute(xw)), sum(np.absolute(yw)), sum(np.absolute(zw)),
                             (max(xw) - min(xw)), (max(yw) - min(yw)), (max(zw) - min(zw)),
                             max(jerkxw), max(jerkyw), max(jerkzw), "1"])
    resultfile.close();